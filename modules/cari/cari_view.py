...
class CariModulu(SayfaliListeMixin, tk.Frame):
    ...
    def listele(self):
        ...
        # Cari hesabı içeren fişleri getir: JOIN + DISTINCT yerine alt sorgu
        satir_filtreleri = ["hesap_turu = 'Cari'", "firma_id = ?"]
