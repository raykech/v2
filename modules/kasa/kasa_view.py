...
class KasaModulu(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.yeni_fis_menu.add_command(label="Kasa Tahsil Fişi", command=lambda: self._ac_yeni_fis_formu("Kasa Tahsil Fişi"))
        ...
        self.cmb_fis_turu_filtre = ttk.Combobox(filter_frame, state="readonly", width=25, values=["Tümü", "Kasa Gider Fişi", "Kasa Tahsil Fişi", "Kasalar Arası Virman"])
